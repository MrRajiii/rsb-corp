...
import 'two_storey_viewmodel.dart';

class TwoStoreyView extends StackedView<TwoStoreyViewModel> {
  const TwoStoreyView({Key? key}) : super(key: key);

  @override
  Widget builder(
      BuildContext context, TwoStoreyViewModel viewModel, Widget? child) {
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Pass viewModel to the card so it can access the methods
  ...
  @override
  TwoStoreyViewModel viewModelBuilder(BuildContext context) =>
      TwoStoreyViewModel();
}
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        Text("Two-Storey Residential House",
            style: GoogleFonts.plusJakartaSans(
        ...
        const SizedBox(height: 16),
        Text(
          "You can customize your preferred designs and interior! We have different options to choose from to make it uniquely yours.",
          style: GoogleFonts.plusJakartaSans(
...
class _PriceInquiryCard extends StatelessWidget {
  final TwoStoreyViewModel viewModel;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 32),
          _ActionButton(
            onPressed: viewModel.onInquireTap, // Logic from ViewModel
            label: "Inquire Now",
          ...
          _ActionButton(
            onPressed: () => viewModel
                .onScheduleVisitTap(context), // Passes context for Pickers
    ...
    return Column(
      ...
      children: [
        ...
        Wrap(
          ...
          runSpacing: 16,
          children: const [
            _FeatureTile(icon: Icons.bed_outlined, label: "4 Bedrooms"),
            _FeatureTile(
                icon: Icons.restaurant_outlined, label: "Dining and Kitchen"),
            _FeatureTile(icon: Icons.chair_outlined, label: "Living Room"),
            _FeatureTile(icon: Icons.wc_outlined, label: "Toilet and Bath"),
            _FeatureTile(
                icon: Icons.directions_car_filled_outlined, label: "Parking"),
            _FeatureTile(icon: Icons.balcony_outlined, label: "Balcony"),
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        const _LocationRow(location: "Balacbac", size: "100 - 310sqm"),
        const _LocationRow(location: "Tuba", size: "100 - 340sqm"),
          ...
          itemBuilder: (context, index) {
            return ClipRRect(
              ...
              child: Image.asset(images[index + 1],
                  fit: BoxFit.cover), // Changed from .network to .asset
            );
          },
        ),
      ],
...
class _ActionButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ElevatedButton.icon(
      onPressed: onPressed, // Connected the parameter to the widget
